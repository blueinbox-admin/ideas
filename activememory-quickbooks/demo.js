...
(function (AM) {
  ...
  function playOnboarding() {
    ...
    obTimers.push(setTimeout(function () {
      chalkAnnotate('.app-win', 'This is us, working right alongside Claude. We remember how your books are set up, so Claude gets your categories and rules right without you repeating yourself. Go ahead, play with it.', { corner: 'top-left' });
    }, 8600));
